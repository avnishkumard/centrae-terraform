locals {
  ...
  alb_https_listener_arns   = data.terraform_remote_state.alb.outputs.https_listener_arns
  repository_url            = data.terraform_remote_state.ecr-repo.outputs.ecr_repo_url
}
